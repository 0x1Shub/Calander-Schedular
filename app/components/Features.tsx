  ...
  return (
    <div className="py-24">
      <div className="max-w-2xl mx-auto lg:text-center">
        ...
        Introducing Timely, Schedule and join meetings in minutes with ease. Enjoy fast setup, seamless access, and timely reminders for every meeting. Timely ensures your time is always well-managed. Experience simplicity and efficiency with Timely!
        </p>
      </div>
